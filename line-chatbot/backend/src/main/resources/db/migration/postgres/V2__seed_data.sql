...
INSERT INTO qa_pairs (keyword, answer, is_active, priority, match_type, created_by)
...
INSERT INTO qa_pairs (keyword, answer, is_active, priority, match_type, created_by)
VALUES ('聯絡方式', '您可以透過以下方式聯絡我們：' || chr(10) || '電話：02-1234-5678' || chr(10) || 'Email：support@example.com', TRUE, 80, 'CONTAINS', NULL)
ON CONFLICT DO NOTHING;
